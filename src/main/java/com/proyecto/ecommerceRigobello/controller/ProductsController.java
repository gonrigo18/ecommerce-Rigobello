...
public class ProductsController {
    ...
    @GetMapping(value="/")
    public ResponseEntity<List<ProductsModel>> findAll() throws ResourceNotFoundException {
    ...
    public ResponseEntity<String> deleteById(@PathVariable(name = "id") Long id) throws ResourceNotFoundException, ResourceAlreadyExistsException {
